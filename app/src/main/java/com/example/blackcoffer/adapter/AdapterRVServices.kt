...
class AdapterRVServices(private val context: Context, private var userList: ArrayList<ModelServices>?)
    : RecyclerView.Adapter<AdapterRVServices.ViewHolder>(){

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdapterRVServices.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.recyclerview_items_services, parent, false)
        return ViewHolder(view)
    }

    @SuppressLint("SetTextI18n")
    override fun onBindViewHolder(holder: AdapterRVServices.ViewHolder, position: Int) {
        ...
        if (pos != null) {
            ...
            holder.experience.text = pos.experience
    ...
    fun updateData(userList: ArrayList<ModelServices>?){
